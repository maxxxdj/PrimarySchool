...
public class TeacherTests {
    ...
    public void testTeacherSalary(){
        double sum = englishTeacher.getSalary();
        englishTeacher.promote(20);
        assertEquals(sum,englishTeacher.getSalary(),0); // expected 500 , actual(promoted) = 600;
    }
    //Comparator by age
    @Test
